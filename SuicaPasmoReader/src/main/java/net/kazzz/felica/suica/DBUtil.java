...
public class DBUtil extends SQLiteOpenHelper {
    ...
    private static final String DB_PATH = "/data/data/jp.caliconography.suicapasmoreader/databases/";

    private static final String DB_NAME = "StationCode";
    private static final String DB_NAME_ASSET = "StationCode.db";
...
//            String path = DB_PATH + DB_NAME;
            String path = mDatabasePath.getAbsolutePath();
    ...
    private void copyDataBase() throws IOException{
        ...
        OutputStream out = new FileOutputStream(mDatabasePath);
