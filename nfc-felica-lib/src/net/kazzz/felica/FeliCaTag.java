...
public class FeliCaTag extends NfcTag {
    ...
    /* (non-Javadoc)
     * @see net.net.kazzz.nfc.NfcTag#writeToParcel(android.os.Parcel, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.net.kazzz.nfc.NfcTag#readFromParcel(android.os.Parcel)
     */
    @Override
    ...
    public ReadResponse readWithoutEncryption(ServiceCode serviceCode,
        ...
        return (r.getBytes()!=null ? new ReadResponse(r) : null);
    }
    /**
     * 認証不要領域のデータを書き込みます
     *
